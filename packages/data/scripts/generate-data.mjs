...
const outputFile = path.join(outputDir, "regions.ts")
...
async function main() {
  ...
  const content = renderGeneratedFile(cityRecords, regionRecords, {
    ...sourceInfo,
    记录数量: stats,
  })
